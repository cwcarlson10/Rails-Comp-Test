...
RSpec.describe CreditCardChargesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all credit_card_charges as @credit_card_charges" do
      credit_card_charge = CreditCardCharge.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:credit_card_charges)).to eq([credit_card_charge])
    end
  end

  describe "GET show" do
    it "assigns the requested credit_card_charge as @credit_card_charge" do
      credit_card_charge = CreditCardCharge.create! valid_attributes
      get :show, {:id => credit_card_charge.to_param}, valid_session
      expect(assigns(:credit_card_charge)).to eq(credit_card_charge)
    end
  end

  describe "GET new" do
    it "assigns a new credit_card_charge as @credit_card_charge" do
      get :new, {}, valid_session
      expect(assigns(:credit_card_charge)).to be_a_new(CreditCardCharge)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created credit_card_charge as @credit_card_charge" do
        post :create, {:credit_card_charge => valid_attributes}, valid_session
        expect(assigns(:credit_card_charge)).to be_a(CreditCardCharge)
        expect(assigns(:credit_card_charge)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved credit_card_charge as @credit_card_charge" do
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      it "assigns the credit_card_charge as @credit_card_charge" do
        credit_card_charge = CreditCardCharge.create! valid_attributes
